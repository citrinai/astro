...
const IconWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <div className="w-10 h-10 p-2 bg-indigo-900/50 rounded-full border border-indigo-700">{children}</div>
);

export const PersonalityIcon: React.FC = () => (
    <IconWrapper>
...
export const RemediesIcon: React.FC = () => (
    <IconWrapper>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
